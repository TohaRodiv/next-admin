...
import { EntityViewsFooter } from "#components/pages/entity-view/entity-views/EntityViewsFooter";
import { EntityViewsFormatted } from "#components/pages/entity-view/entity-views/EntityViewsFormatted";
